...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of YukiAppDelegate.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/792115885@qq.com/YukiAppDelegate'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { '792115885@qq.com' => '792115885@qq.com' }
  s.source           = { :git => 'https://github.com/792115885@qq.com/YukiAppDelegate.git', :tag => s.version.to_s }
